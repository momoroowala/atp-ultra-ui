...
import { Bell, User, Settings, LogOut, AlertTriangle, MessageSquare, AtSign, MessageCircle } from 'lucide-react';
...
export const TopBanner = () => {
  ...
  const { mentions, unreadDMs, totalCount: bellNotifCount, markBellRead } = useBellNotifications();
        ...
        <Popover onOpenChange={handleBellOpen}>
          ...
          <PopoverContent align="end" className="w-80 p-0 z-[60]">
            ...
            <div className="max-h-64 overflow-y-auto">
              ...
              {/* Empty state */}
              {flaggedCount === 0 && allNotifications.length === 0 && (
