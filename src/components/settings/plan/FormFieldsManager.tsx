...
export const FormFieldsManager = ({ taskId, open, onOpenChange, children }: FormFieldsManagerProps) => {
  ...
  const createFormSection = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast.error(error.message || 'You may not have permission to create form sections.');
    },
  });
  ...
  const createFormField = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast.error(error.message || 'You may not have permission to add form fields.');
    },
  });
  ...
  const updateFormField = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast.error(error.message || 'You may not have permission to update form fields.');
    },
  });
  ...
  const deleteFormField = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast.error(error.message || 'You may not have permission to delete form fields.');
    },
  });
