import { Calendar, Lock, ArrowRight, CalendarDays } from 'lucide-react';
...
export const CalendarWidget = () => {
  ...
  return (
    <div className="rounded-xl border border-border/60 bg-card overflow-hidden shadow-sm">
      {/* Gradient header */}
      <div className="relative px-4 py-3 bg-gradient-to-r from-sky-500/20 via-sky-500/10 to-transparent">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center h-7 w-7 rounded-lg bg-sky-500/15">
