...
import { Check, CheckCircle2, AlertTriangle, FileText, Play, StickyNote, Loader2, Clock, BookOpen, ChevronRight, Save } from 'lucide-react';
...
export const SprintTaskDetailDrawer = ({ task, open, onOpenChange, status, onToggle, getModuleLink }: Props) => {
  ...
  const { content, updateContent, saveNow, loading: notesLoading, saved } = useSprintTaskNotes(open && task ? task.id : null);
