...
export const MessageInput = ({ channelId, conversationId, channelName, replyingTo, onCancelReply, sendMessage, onAfterSend }: MessageInputProps) => {
  ...
  const handleKeyDown = (e: KeyboardEvent<HTMLTextAreaElement>) => {
    ...
    // Shift+Enter: let textarea handle the newline naturally (no preventDefault)
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-end gap-3 bg-card rounded-xl border border-border px-3 py-2">
        <input
          ref={fileInputRef}
          type="file"
          multiple
        ...
        <div className="flex-1 flex items-center flex-wrap gap-1">
          ...
          <textarea
            ...
            className="flex-1 min-w-[120px] bg-transparent border-0 outline-none text-sm placeholder:text-muted-foreground py-2"
