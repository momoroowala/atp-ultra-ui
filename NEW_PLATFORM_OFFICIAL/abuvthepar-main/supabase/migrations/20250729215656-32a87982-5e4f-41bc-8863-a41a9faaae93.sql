-- Insert micro lessons data
INSERT INTO public.micro_lessons (archetype, lesson_text, citation, source_url) VALUES 
...
('strategy_hopper', 'Strategy‑switching drag: –3.7 % p.a. vs benchmark (Barber‑Odean meta).', 'Barber‑Odean meta', 'https://faculty.haas.berkeley.edu/odean/papers%20current%20versions/behavior%20of%20individual_investors.pdf'),
