-- Drop and recreate the check_phase_base_conditions function with correct unlock_type values
DROP FUNCTION IF EXISTS public.check_phase_base_conditions(uuid, uuid);
...
BEGIN
  ...
  -- Check unlock type (updated to match UI strings)
