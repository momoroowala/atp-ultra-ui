...
export const MilestonesChecklist = ({ className }: { className?: string }) => {
  ...
  return (
    <div data-tour="milestones-checklist" className={cn("rounded-xl border border-primary/30 bg-card overflow-hidden shadow-[0_0_16px_rgba(85,189,138,0.1)]", className)}>
      {/* Header */}
          ...
          <div className="flex-1 h-1.5 rounded-full bg-muted overflow-hidden">
            <div
              ...
              style={{
                ...
                background:
                  'radial-gradient(160.59% 161.46% at 50% 0%, hsl(var(--primary)) 0%, #6EDAA6 100%)',
              }}
            >
