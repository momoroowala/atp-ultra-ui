...
import { formatTimeInUserTZ, formatDateLabelInUserTZ, formatTimeInEST, formatDateLabelInEST, isUserInEST, getDateInUserTimezone } from '@/utils/timezoneHelpers';
        ...
        <div className="flex-1 p-4 flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              {tzMode === 'est'
                ? <>{formatDateLabelInEST(call.call_date, call.call_time, call.timezone)} at {formatTimeInEST(call.call_date, call.call_time, call.timezone)}{!isUserInEST() && <span className="text-xs opacity-70 ml-1">({formatTimeInUserTZ(call.call_date, call.call_time, call.timezone)})</span>}</>
                : <>{formatDateLabelInUserTZ(call.call_date, call.call_time, call.timezone)} at {formatTimeInUserTZ(call.call_date, call.call_time, call.timezone)}{!isUserInEST() && <span className="text-xs opacity-70 ml-1">({formatTimeInEST(call.call_date, call.call_time, call.timezone)})</span>}</>
              }
            </p>
