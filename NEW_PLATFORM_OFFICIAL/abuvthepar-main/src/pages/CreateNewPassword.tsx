    ...
    const checkAuth = async () => {
      ...
      if (error) {
        ...
        toast({
          ...
          description: error || "The link is invalid or has expired.",
          variant: "destructive",
        });
      ...
      if (accessToken && (type === 'invite' || type === 'signup' || type === 'recovery')) {
        ...
        toast({
          ...
          description: "Please request a new invitation or check your email for the latest link.",
          variant: "destructive",
        });
  ...
  const handleSetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your account is now active. Redirecting to home...",
      });
