...
BEGIN
  ...
  SELECT base.id, base.email, base.first_name, base.last_name, base.tier_name, base.tier_id, base.role_name, base.role_id,
    base.is_active, base.total_tasks, base.completed_tasks, base.progress_percentage, base.created_at, base.last_sign_in_at, base.total_count,
    base.assigned_csm_id
  FROM base
  ORDER BY
