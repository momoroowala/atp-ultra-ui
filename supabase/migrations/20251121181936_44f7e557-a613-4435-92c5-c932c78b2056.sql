-- Fix search_path security warning for get_today_habits function
...
-- Fix search_path security warning for toggle_habit_skip function
DROP FUNCTION IF EXISTS toggle_habit_skip(uuid, uuid, date);

CREATE FUNCTION toggle_habit_skip(
  p_user_id uuid,
