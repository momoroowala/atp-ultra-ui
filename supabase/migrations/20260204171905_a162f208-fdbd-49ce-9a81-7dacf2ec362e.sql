-- Drop and recreate the function with additional sorting columns and new default
...
BEGIN
  ...
  ORDER BY
    ...
    -- Created at / joined date sorting
    ...
    -- Store status sorting (boolean - activated first when desc)
